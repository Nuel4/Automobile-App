<%-- 
    Document   : bikeinstalpay.jsp
    Created on : 4 Apr, 2019, 11:28:31 PM
    Author     : Admin
--%>
...
<html>
 ...
 <div class="backimg" style="position: relative">
       ...
       <form method="post" action="bikeinstalpayment.jsp">
            <table>
            <tr>
                <td> <input type="text" name="paid" placeholder="FIRST PAYMENT"</td>
            </tr>
            <tr>
                <tr>
                <td> <input type="text" name="plan" placeholder="Payment Plan"</td>
            </tr>
            <tr>
            <tr>
