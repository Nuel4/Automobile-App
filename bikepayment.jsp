<%-- 
    Document   : bikepayment2.jsp
    Created on : 25 Mar, 2019, 7:36:26 AM
    Author     : Admin
--%>
...
<html>
 ...
 <div class="backimg" style="position: relative">
    ...
    <%
    String amp = session.getAttribute("fin").toString();
            %>
    <body>
         <form method="post" action="bikepayconf.jsp">
            <table>
            <tr>
                <td> <input type="text" name="paid" value="<%=amp%>"</td>
            </tr>
            <tr>
            <tr>
