<%-- 
    Document   : bikeinvoice.jsp
    Created on : 4 Apr, 2019, 10:51:41 PM
    Author     : Admin
--%>
...
if(rs.next())
{
  ...
  out.print("This is to confirm that product below has been paid for by "+nm+" The detail is given blow" );
